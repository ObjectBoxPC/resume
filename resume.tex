...
\newcommand{\locheader}[4]{\makebox[0.5\textwidth][l]{\textbf{#1}} \makebox[0.5\textwidth][r]{#2} \\ \textit{#3} \\ #4}
...
\begin{document}
	...
	\locheader{Major in Computer Science}{August 2015 -- present}{California State University, Fullerton}{Fullerton, California}
