...
\begin{document}
	...
	\begin{itemize}
		...
		\item Developed and integrated Web API services with ASP.NET Core, .NET Framework, SQL Server, and MongoDB to exchange shipment data with external sources (JSON, XML, SOAP)
