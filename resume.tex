...
\begin{document}
	...
	Software developer with 5 years of experience delivering enterprise Web applications, with a strong focus on quality and attention to detail. Adaptable to various environments and technologies, skilled in communicating with diverse stakeholders.
	...
	\begin{itemize}
		\item Laid off due to company acquisiton
	...
	\begin{itemize}
		...
		\item Developed and maintained cloud-based microservice Web applications with ASP.NET Core, Docker, and .NET Framework, enabling delivery of health and beauty products to 10M+ customers worldwide
