...
\begin{document}
	...
	\begin{itemize}
		...
		\item Collaborated with business teams and software testers to clarify requirements
		\item Resolved user-reported issues, documenting causes and remedies in detail
