...
\begin{document}
	...
	\locheader{Major in Computer Science (Pursuing BS)}{August 2015 -- May 2018}{California State University, Fullerton}{Fullerton, California}
	...
	\projheader{Android Smartwatch App}{October 2016}{Citrus Hack ``hackathon'' competition (Riverside, California)}{Java}

	\begin{itemize}[noitemsep]
		\item Worked with team members to create app in just 36 hours for hackathon competition
	\end{itemize}

	\projheader{Operating Systems Group Assignments}{August 2016 -- December 2016}{California State University, Fullerton (Fullerton, California)}{C++}
	...
	\projheader{Linux Assembly Library}{February 2016 -- May 2016}{Personal}{C, assembly}
	...
	\projheader{Pi Day Fractal Drawing Programs}{January 2015 -- March 2015}{Pasadena City College (Pasadena, California)}{C++}

	\begin{itemize}[noitemsep]
		\item Worked with team members to deliver engaging math visualizations
	\end{itemize}

	\projheader{Music Website}{May 2014 -- October 2015}{Personal}{PHP}
