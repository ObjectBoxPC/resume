...
\begin{document}
	...
	\begin{itemize}
		...
		\skillitem{Front-end Web development}{JavaScript, Vue, Node.js}
		\skillitem{Back-end Web development}{ASP.NET Core, SQL Server, Redis}
	...
	\locheader{Junior Developer}{December 2018 -- Present}{iHerb}{Irvine, California}

	\begin{itemize}
		\item Developed software for managing worldwide shipments of natural and herbal products
		\item Created Web portal with Vue and ASP.NET Core to greatly improve maintainability over previous portal
	\end{itemize}
	...
	\begin{itemize}
		\item Created mathematical library for representing infinite values
