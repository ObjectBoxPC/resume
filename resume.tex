...
\begin{document}
	...
	\begin{itemize}
		\item Adapted and refactored code for a back-end social networking site using Flask framework (MVC)
		\item Added JSON REST API to provide access from front-end applications and mobile apps
		\item Integrated application with relational (SQL) database, MongoDB, and Redis
		\item Automated testing and deployment tasks with Bash shell scripts
	\end{itemize}
